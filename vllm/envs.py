...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_USE_AITER_GEMM_AUTOTUNE: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Run aiter GEMM tuner for missing shapes before CUDA graph capture
    "VLLM_ROCM_USE_AITER_GEMM_AUTOTUNE": lambda: (
        os.getenv("VLLM_ROCM_USE_AITER_GEMM_AUTOTUNE", "False").lower() in ("true", "1")
    ),
